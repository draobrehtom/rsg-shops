...
Config.Products = {
    ...
    ["weapons"] = {
        ...
        [29] = { name = "ammo_varmint",                        price = 0.75, amount = 500, info = {}, type = "item",   slot = 29, },
        [30] = { name = "ammo_repeater",                       price = 0.75, amount = 500, info = {}, type = "item",   slot = 30, },
        [31] = { name = "ammo_shotgun",                        price = 0.75, amount = 500, info = {}, type = "item",   slot = 31, },
        [32] = { name = "ammo_arrow",                          price = 0.10, amount = 500, info = {}, type = "item",   slot = 32, },
    },
}
